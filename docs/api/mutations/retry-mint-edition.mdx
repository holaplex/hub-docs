---
id: retry-mint-edition
title: retryMintEdition
...
#### [<code style={{ fontWeight: 'normal' }}>retryMintEdition.<b>input</b></code>](#)<Bullet />[`RetryMintEditionInput!`](/api/inputs/retry-mint-edition-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
> 
> 
